...
<form action='register.php' method='post' id='register'>
	...
	<table class='table table-responsive'>
		...
		<tr>
			...
			<td><input type='text' name='nombre' class='form-control' required value="<?php echo isset($_POST['nombre']) ? htmlspecialchars($_POST['nombre'], ENT_QUOTES) : "";  ?>" /></td>
		</tr>
		...
		<tr>
			<td>Password</td>
			<td><input type='password' name='clave' class='form-control' required id='passwordInput'></td>
		</tr>
